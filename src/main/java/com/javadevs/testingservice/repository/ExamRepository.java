...
public interface ExamRepository extends JpaRepository<Exam, Long> {
    ...
    @Query("SELECT DISTINCT e FROM Exam e LEFT JOIN FETCH e.student s LEFT JOIN FETCH s.subjects" +
            " LEFT JOIN FETCH e.questions q LEFT JOIN FETCH q.answers LEFT JOIN FETCH q.subject LEFT JOIN FETCH e.results WHERE e.id=?1")
    ...
    @Query(value = "SELECT DISTINCT e FROM Exam e LEFT JOIN FETCH e.student s LEFT JOIN FETCH s.subjects" +
            " LEFT JOIN FETCH e.questions q LEFT JOIN FETCH q.answers LEFT JOIN FETCH q.subject LEFT JOIN FETCH e.results",
